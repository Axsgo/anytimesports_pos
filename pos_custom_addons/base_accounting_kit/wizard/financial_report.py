...
class FinancialReport(models.TransientModel):
    ...
    def _compute_account_balance(self, accounts):
        ...
        if accounts:
            ...
            wheres = [""]
            print(tables,'tabb')
            print(where_clause,'wheeee')
            print(where_params,'paraaaaaaaa')
            ...
            print(self.env.cr.dictfetchall(),'dicccccccccccccc')
